...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { source: @picture.source, user_id: @picture.user_id } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { source: @picture.source, user_id: @picture.user_id } }
